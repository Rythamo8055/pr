...
export function BottomNavBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-20 bg-transparent z-50 flex justify-center items-center px-4">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {!isActive && <span className="text-xs mt-0.5 sm:mt-1 text-transparent">{item.label}</span>}
            </Link>
          );
        })}
      </div>
